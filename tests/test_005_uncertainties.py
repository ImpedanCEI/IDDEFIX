...
class TestAnalyticalImpedance:
    ...
    def setup_class(cls):
        ...
        cls.popt, cls.pcov = curve_fit(objective_function,
                cls.frequency,
    ...
    def test_abs_DE_impedance(self, plot: bool = False):
        ...
        if plot:
            ...
            plt.plot(self.frequency, z_true, label="Target impedance", lw=5, 
                     color='black')
    ...
    def test_uncertainties(self):
        ...
        np.testing.assert_allclose(uncertainties_min/uncertainties_cf,
...
if __name__ == "__main__":
    ...
    t.setup_class()
    print("Running analytical impedance fitting and uncertainty"
          " tests with plots...")
    t.test_DE_model()
